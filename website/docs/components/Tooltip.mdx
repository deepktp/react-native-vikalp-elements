...
| `animationType`            | `none` \| `fade`                                           | `fade`        | Control tooltip animation                                                                                                                                                                                                                               |
...
| `onClose`                  | Function                                                   | `() => { }`   | Function which gets called on closing the tooltip.                                                                                                                                                                                                      |
| `onOpen`                   | Function                                                   | `() => { }`   | Function which gets called on opening the tooltip.                                                                                                                                                                                                      |
