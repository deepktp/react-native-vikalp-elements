...
<div class="row inline-flex-center">
  ...
  <div class="col col--9">
    <CodeBlock>{`import { Header } from '@rn-vui/themed';`}</CodeBlock>
  </div>
  <div class="col col--3">
    <h4>
      Theme Key{" "}
...
| `children`             | `(ReactElement<unknown, string` \| `JSXElementConstructor<any>>` \| `ReactElement<unknown, string` \| `JSXElementConstructor<any>>[]) & ReactNode` | `[]`                       | Add children component to the header.                           |
...
| `placement`            | `center` \| `right` \| `left`                                                                                                                      | `center`                   | Alignment for title.                                            |
