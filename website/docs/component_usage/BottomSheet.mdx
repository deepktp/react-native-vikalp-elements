...
**Note:** Bottom Sheet Supports [Safe Area View Props](https://appandflow.github.io/react-native-safe-area-context/api/safe-area-view). You can remove bottom safe area padding by adding porp `edges={{bottom: 'off'}}`.
