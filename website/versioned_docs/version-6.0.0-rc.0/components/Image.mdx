...
<div class="row inline-flex-center">
  ...
  <div class="col col--9">
    <CodeBlock>{`import { Image } from '@rn-vui/themed';`}</CodeBlock>
  </div>
  <div class="col col--3">
    <h4>
      Theme Key{" "}
...
| `PlaceholderContent`     | `ReactElement<unknown, string` \| `JSXElementConstructor<any>>` |                                                   | Content to load when Image is rendering.              |
