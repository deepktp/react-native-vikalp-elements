...
export const ListItemSwipeable = ({ children, leftStyle, rightStyle, leftContent, rightContent, leftWidth = ScreenWidth / 3, rightWidth = ScreenWidth / 3, minSlideWidth = ScreenWidth / 3, onSwipeBegin, onSwipeEnd, animation = { type: 'spring', duration: 200 }, ...rest }) => {
    ...
    return (React.createElement(View, { style: styles.container },
        ...
        React.createElement(Animated.View, { style: {
            ...
            React.createElement(ListItemBase, { ...rest }, children))));
};
