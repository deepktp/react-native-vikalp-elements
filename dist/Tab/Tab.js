...
export const TabBase = (_a) => {
    var _b, _c, _d;
    var { theme = defaultTheme, children, scrollable = false, onChange = () => { }, indicatorStyle, disableIndicator, variant = 'primary', style, dense, iconPosition, buttonStyle, titleStyle, containerStyle, activeIndex = 0, animationType = 'spring', animationConfig = {} } = _a, rest = __rest(_a, ["theme", "children", "scrollable", "onChange", "indicatorStyle", "disableIndicator", "variant", "style", "dense", "iconPosition", "buttonStyle", "titleStyle", "containerStyle", "activeIndex", "animationType", "animationConfig"]);
    ...
    const scrollHandler = React.useCallback((currValue) => {
        ...
        if (tabItemPositions.current.length >= currValue + 1) {
            ...
            const scrollX = itemPosition + itemWidth / 2 - tabContainerCurrentWidth / 2;
