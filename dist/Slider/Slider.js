...
export const Slider = ({ allowTouchTrack = false, animateTransitions = false, animationConfig = {}, animationType = 'timing', containerStyle = styles, debugTouchArea = false, disabled, maximumTrackTintColor = '#b3b3b3', maximumValue = 1, minimumTrackTintColor = '#3f3f3f', minimumValue = 0, onSlidingComplete, onSlidingStart, onValueChange, orientation = 'horizontal', step = 0, style, thumbProps, thumbStyle, thumbTintColor = 'red', thumbTouchSize = { width: THUMB_SIZE, height: THUMB_SIZE }, trackStyle, value: _propValue = 0, ...other }) => {
